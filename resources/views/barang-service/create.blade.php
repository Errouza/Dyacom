        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-6">
                        <h2 class="text-2xl font-semibold">Tambah Barang Service</h2>
                    </div>

                    <form action="{{ route('barang-service.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="jenis_product" id="jenis_product" value="{{ old('jenis_product') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                        required>
                                    @error('jenis_product')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
