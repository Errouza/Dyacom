                ...
                <div class="card-body">
                    <form action="{{ route('penjualan.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('id_pesanan') is-invalid @enderror" id="id_pesanan" name="id_pesanan" value="{{ old('id_pesanan') }}" required>
                            @error('id_pesanan')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('price_total') is-invalid @enderror" id="price_total" name="price_total" value="{{ old('price_total') }}" required min="0">
                            @error('price_total')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('metode_pengambilan') is-invalid @enderror" id="metode_pengambilan" name="metode_pengambilan" required>
                                ...
                                <option value="Pickup" {{ old('metode_pengambilan') == 'Pickup' ? 'selected' : '' }}>Pickup</option>
                                <option value="Delivery" {{ old('metode_pengambilan') == 'Delivery' ? 'selected' : '' }}>Delivery</option>
                            </select>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('status_pembayaran') is-invalid @enderror" id="status_pembayaran" name="status_pembayaran" required>
                                ...
                                <option value="Selesai" {{ old('status_pembayaran') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
